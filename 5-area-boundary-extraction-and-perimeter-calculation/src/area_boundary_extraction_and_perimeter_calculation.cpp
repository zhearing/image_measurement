...
int main(int argc, char** argv)
{
	...
	imshow("origin", image);
	Mat L1 = imread("../../5-area-boundary-extraction-and-perimeter-calculation/images/origin.bmp", -1);
	Mat L2 = imread("../../5-area-boundary-extraction-and-perimeter-calculation/images/origin.bmp", -1);
