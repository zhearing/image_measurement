...
{
	Mat image1 = imread("../../1-image-smoothing-and-image-enhancement/images/lena.bmp", -1);
	Mat image2 = imread("../../1-image-smoothing-and-image-enhancement/output/ave_image.bmp", -1);
	Mat image3 = imread("../../1-image-smoothing-and-image-enhancement/output/salt_image.bmp", -1);
	...
	imwrite("../../1-image-smoothing-and-image-enhancement/origin_enhancement.bmp", Enhancement(image1, k));
	...
	imwrite("../../1-image-smoothing-and-image-enhancement/output/mid_image_enhancement.bmp", Enhancement(image2, k));
	...
	imwrite("../../1-image-smoothing-and-image-enhancement/output/salt_image_enhancement.bmp", Enhancement(image3, k));
	waitKey(0);
	return 0;
}
